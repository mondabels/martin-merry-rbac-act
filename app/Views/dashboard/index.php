...
<div class="py-2">
    ...
    <!-- Common Basic Info Card (Shown for all roles) -->
                ...
                <div class="card-body p-4 d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <span class="badge" style="background-color: var(--hover-color); color: var(--accent-color); font-size: 0.85em; padding: 5px 10px;">
                                <?= esc(strtoupper($role)) ?>
                            </span>
                        </div>
                    </div>
                    <div>
                        <a href="<?= base_url('profile') ?>" class="btn btn-outline-light" style="border-color: var(--accent-color); color: var(--accent-color); border-radius: 8px; padding: 10px 20px;">
    ...
    <?php if ($role === 'student'): ?>
        ...
        <div class="card card-custom border-0 shadow-lg overflow-hidden" style="border-radius: 12px;">
                    ...
                    <table class="table table-custom mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="px-4 py-3 text-muted">Dr. Alan Turing</td>
                            </tr>
                            <tr>
                                ...
                                <td class="px-4 py-3 text-muted">Ms. Ada Lovelace</td>
                            </tr>
                            <tr>
                                ...
                                <td class="px-4 py-3 text-muted">Prof. Grace Hopper</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="card-footer border-0 p-3 text-center" style="background-color: var(--hover-color);">
                <small class="text-muted"><i class="bi bi-info-circle me-1"></i> Data shown is a placeholder demonstration.</small>
            </div>
        </div>
                    ...
                    <table class="table table-custom mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="px-4 py-3 text-center"><span class="badge" style="background-color: var(--accent-color); color: var(--bg-color);">35</span></td>
                            </tr>
                            <tr>
                                <td class="px-4 py-3 fw-bold ">CS101</td>
                                <td class="px-4 py-3 text-muted">Introduction to Programming</td>
                                <td class="px-4 py-3 text-muted">Block B</td>
                                <td class="px-4 py-3 text-center"><span class="badge" style="background-color: var(--accent-color); color: var(--bg-color);">28</span></td>
                            </tr>
                            <tr>
                                ...
                                <td class="px-4 py-3 text-center"><span class="badge" style="background-color: var(--accent-color); color: var(--bg-color);">42</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <a href="<?= base_url('students/create') ?>" class="text-decoration-none h-100 d-block">
                    <div class="card card-custom border-0 shadow-sm w-100 p-5 transition-hover text-center h-100 d-flex flex-column justify-content-center" style="border-radius: 12px; background-color: var(--secondary-color);">
